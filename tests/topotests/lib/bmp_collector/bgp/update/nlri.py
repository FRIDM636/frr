...
def padding(databin, len_):
    ...
    Assumption:
        ...
        a padding to the prefix without carring about its length
    """
    if len(databin) >= len_:
        return databin
...
def dissect_nlri(nlri_data, afi, safi):
    ...
    elif addr_family == AF.IPv4_UNICAST:
        pass
...
class NlriIPv4Unicast:
    ...
    def parse(data):
        ...
        return f'{ipaddress.IPv4Address(prefix)}/{prefix_len}'
...
class NlriIPv6Unicast:
    ...
    def parse(data):
        ...
        return f'{ipaddress.IPv6Address(prefix)}/{prefix_len}'
...
class NlriIPv4Vpn:
    ...
    def parse(cls, data):
        ...
        return {
            ...
            'ipv4': f'{ipaddress.IPv4Address(ipv4)}/{prefix_len}',
        }
...
class NlriIPv6Vpn:
    ...
    def parse(cls, data):
        ...
        return {
            'label': decode_label(label),
            'rd': str(RouteDistinguisher(rd)),
            'ipv6': f'{ipaddress.IPv6Address(ipv6)}/{prefix_len}',
        }
